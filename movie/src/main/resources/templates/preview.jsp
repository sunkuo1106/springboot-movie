...
<div class="main">
                ...
                <div class="cont-desc span_1_of_2">
                    <div class="product-details">
                        ...
                        <div class="desc span_3_of_2">
                            <h2>${info.title}</h2><c:if test="${info.rating!=-1}"><span style="color:red;position: absolute;top: 230px;left: 630px;">${info.rating}</span></c:if>
    ...
    <div class="selectbox">
        <div class="selemediv">
            <div class="selemenu " >
                <span class="sqinput">选择影城</span><span class="csinput"></span></div>
...
<%--                </div>--%>
                <div class="xzk">
                    <div class="leibie">影城</div>
                    <ul class="chengshi xhyc">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $.post("/previewyc","",function (result) {
            $.each(result.yc,function (i,v) {
                if(i<1){
                    $(".xhyc").append("<li class=\"active ycli\">"+v.cinemaName+" <input type=\"hidden\" class='cinemaId' value=\""+v.cinemaId+"\"><input hidden class='yingchengName' value='"+v.cinemaName+"'></li>");
                }else{
                    $(".xhyc").append("<li class='ycli'>"+v.cinemaName+" <input type=\"hidden\" class='cinemaId'  value=\""+v.cinemaId+"\"><input hidden class='yingchengName' value='"+v.cinemaName+"'></li>");
                }
            })
            var time=new Date();
            ...
            $.post("/previewcc",json,function (result) {
